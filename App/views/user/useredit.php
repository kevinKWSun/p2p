...
<body>
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/ausers/edit" class="layui-form layui-form-pane" method="post">
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="doPost" data-url="/ausers/edit"><i class="layui-icon">&#x1005;</i>提交</a>

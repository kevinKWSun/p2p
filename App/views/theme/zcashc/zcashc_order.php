                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zcashca/zcashc_order.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<?php if(is_rule('/zcashca/zcashc_order_export')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-export" data-url="/zcashca/zcashc_order_export.html">
												<i class="fa fa-search"></i>导出
											</a>
										<?php } ?>
										<?php if(is_rule('/zcashca/batch_zcashc_order')) { ?>
										<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-batch" data-href="/zcashca/batch_zcashc_order">
                                            <i class="layui-icon">&#xe6b2;</i>批量编辑
                                        </a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zcashca/zcashc_order.html">
                                            <i class="layui-icon">&#xe669;</i>重新载入
                                        </a>
                                    </div>
									<?php if(is_rule('/zcashca/view_rate')) { ?>
									<div class="layui-inline" style="float:right;color:#c6c6c6;">
										188概率：<?php echo $num188, '%'; ?>
										288概率：<?php echo $num288, '%'; ?>
										388概率：<?php echo $num388, '%'; ?>
										588概率：<?php echo $num588, '%'; ?>
										788概率：<?php echo $num788, '%'; ?>
                    ...
                    <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>
									<?php if($v['status'] == 0) { ?>
										<a class="layui-btn layui-btn-sm js-modify" data-url="/zcashca/deal_zcashc_ui/<?php echo $v['id']; ?>.html"><i class="layui-icon">&#xe642;</i>编辑</a>
									<?php } else { ?>
										--
									<?php } ?>
								</td>

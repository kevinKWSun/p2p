	...
	<body>
			<!--<div class="header">
					<div class="top">
						<div class="sn-menu">
							<?php if(! QUID){ ?>
								<a class="menu-hd" href="/suny/login.html?ret_url=/zcashc.html"><i class="icon"></i>登录<b class="icon"></b></a>
							<?php }else{?>
								<a class="menu-hd" href="/account.html"><i class="icon"></i>我的账户<b class="icon"></b></a>
								<div class="menu-bd">
									<div class="menu-bd-panel"> 
										<a href="/suny/out.html?ret_url=/zcashc.html">退出</a>
									</div>
								</div>
							<?php }?>
				        </div>
		...
		<div id="lucky-body">
			<div id="lucky-banner">
				<img src="/lucky/img/banner-new.jpg" >
			</div>
			<div id="lucky-main">
				<div class="lucky-main-packet">
					<ul>
						...
						<li class="js-388">
							<img src="/lucky/img/packet-388.png" >
							<span>X<var><?php echo $m388; ?></var></span>
						</li>
						<li class="js-588">
						...
						<li class="js-788">
							<img src="/lucky/img/packet-788.png" >
							<span>X<var><?php echo $m788; ?></var></span>
						</li>
						<li class="js-888">
				...
				<div class="lucky-main-operate">
					<?php if(!QUID) { ?>
						<p class="">
							您尚未登录，<a href="/suny/login.html?ret_url=/zcashc.html">去登录</a>
						</p>
					<?php } else { ?>
						<p class="">
					...
					<p class="lucky-count">
						<label><input type="radio" name="fudai" value="1" checked/>您当前剩余福袋（<var><?php echo isset($zcashc) ? $zcashc['total'] : 0; ?></var>）</label> | <strong><a href="/zcashc.html?rel=<?php echo time(); ?>#lucky">刷新试试</a></strong>
					</p>
				</div>
				<div class="lucky-main-rule">
					<img src="/lucky/img/rule-new.jpg" >
				</div>
			</div>
		</div>	
			...
			$(".lucky-main-home li img").each(function(i, n) {
				$(this).on('click', function() {
					...
					if(obj_fudai.val() == 1 && parseInt(obj_fudai.parent('label').find('var').html()) < 1) {
						layer.msg('剩余福袋次数不足', {icon: 5, time: 1500});
						return;
					}
					...
					if(!flag) {
						$.post('/zcashc/get_money.html', {doub:obj_fudai.val()}, function(r) {
							if(r.state == 1) {

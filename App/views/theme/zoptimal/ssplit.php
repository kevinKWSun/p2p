...
<body>
                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zoptimala/ssplit.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<?php if(is_rule('/zoptimala/batch_red_provide')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-batch" data-href="/zoptimala/batch_red_provide">
												<i class="layui-icon">&#xe6b2;</i>批量编辑
											</a>
										<?php } ?>
										<?php if(is_rule('/zoptimala/dossplit')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-dossplit" data-url="/zoptimala/dossplit.html">
												<i class="fa fa-search"></i>拆分
											</a>
										<?php } ?>
										<?php if(is_rule('/zoptimala/detail_export')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="excel" data-url="/zoptimala/ssplit_export.html">
												<i class="fa fa-search"></i>导出
											</a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zoptimala/ssplit.html">
                    ...
                    <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>
									<?php if($v['status'] == 0 && is_rule('/zoptimala/red_provide')) {?>
										<a class="layui-btn layui-btn-sm " lay-submit="" lay-filter="js-provide" data-url="/zoptimala/red_provide/<?php echo $v['id']; ?>.html"><i class="layui-icon">&#xe642;</i>编辑</a>
									<?php } else { ?>
										--
									<?php } ?>
								</td>
	...
	<script type="text/javascript">
		layui.use(['layer', 'form', 'laydate'], function(){
			...
			form.on('submit(js-dossplit)', function(data) {
				var url = $(this).data('url');
				$.post(url, function(r) {
					if(r.state == 1) {
						location.reload();

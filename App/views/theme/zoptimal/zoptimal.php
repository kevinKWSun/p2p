                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zoptimala/zoptimal.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zoptimala/zoptimal.html">
                ...
                <form class="form-horizontal" id="formrec" method="post" role="form">
                    <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                        ...
                        <tbody>
                            ...
                            <?php }else{foreach ($zoptimal as $v): ?>
                            <tr>
								<td><?php echo $v['id']; ?></td>
                                <td><?php echo $v['uid']; ?></td>
                                <td><?php echo $v['real_name']; ?></td>
								<td><?php echo $v['idcard']; ?></td>
								<td><?php echo $v['money97']; ?></td>
								<td><?php echo $v['money168']; ?></td>
								<td><?php echo $v['surplus']; ?></td>
								<td><?php echo $v['rounds']; ?></td>
								<td><?php echo $v['round']; ?>轮</td>

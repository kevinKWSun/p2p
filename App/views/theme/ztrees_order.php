                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/ztreesa/ztrees_order.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-batch" data-href="/ztreesa/batch_ztrees_order">
                                            <i class="layui-icon">&#xe6b2;</i>批量编辑
                                        </a>
										<?php if(is_rule('/ztreesa/ztrees_export')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="excel" data-url="/ztreesa/ztrees_export.html">
												<i class="fa fa-search"></i>导出
											</a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/ztreesa/ztrees_order.html">
                    ...
                    <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td><?php echo $tree_prize[$v['type']]; ?><?php echo ($v['type'] != 13) ? '元' : ''; ?></td>
								<td>
									<?php if($v['puptime'] > 0) { echo date('Y-m-d H:i', $v['puptime']); } else { echo '--'; } ?>
								</td>
								<td><?php echo date('Y-m-d H:i', $v['addtime']); ?></td>
								<td><?php echo $v['remark']; ?></td>
								<td><?php echo $v['padmin_id'] > 0 ? get_user($v['padmin_id'])['realname'] : ''; ?></td>
								<td>
									<?php if($v['status'] == 0) { ?>
										<a class="layui-btn layui-btn-sm js-modify" data-url="/ztreesa/deal_ztrees_ui/<?php echo $v['id']; ?>.html"><i class="layui-icon">&#xe642;</i>编辑</a>
									<?php } else { ?>
										--
									<?php } ?>
								</td>

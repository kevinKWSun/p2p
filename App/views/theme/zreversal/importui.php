                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zreversala/importui.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<?php if(is_rule('/zreversala/import')) { ?>
											<a class="layui-btn layui-btn-small" id="uploadcsv">
												<i class="fa fa-search"></i>导入
											</a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zreversala/importui.html">
	...
	<script type="text/javascript">
		layui.use(['layer', 'form', 'upload'], function(){
			...
			var uploadInst = upload.render({
				elem: '#uploadcsv' //绑定元素
				,url: '/zreversala/import.html' //上传接口
				,field: 'excel'
				,accept: 'file'
				,exts:	'xlsx|xls'
				,done: function(res){

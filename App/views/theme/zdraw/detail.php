                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zdrawa/detail.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<?php if(is_rule('/zdrawa/batch_detail')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="js-batch" data-href="/zdrawa/batch_detail">
												<i class="layui-icon">&#xe6b2;</i>批量编辑
											</a>
										<?php } ?>
										<?php if(is_rule('/zdrawa/detail_export')) { ?>
											<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="excel" data-url="/zdrawa/detail_export.html">
												<i class="fa fa-search"></i>导出
											</a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zdrawa/detail.html">
                    ...
                    <table class="layui-table layui-tables" lay-skin="line" boder='1'>
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>
									<?php if($v['status'] == 0 && is_rule('/zdrawa/modify')) { ?>
										<a class="layui-btn layui-btn-sm" lay-submit="" lay-filter="js-modify" data-url="/zdrawa/modify/<?php echo $v['id']; ?>.html"><i class="layui-icon">&#xe642;</i>编辑</a>
									<?php } else { ?>
										--
									<?php } ?>
								</td>

                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/zdrawa/importui.html">
                                            <i class="fa fa-search"></i>查询
                                        </a>
										<?php if(is_rule('/zdrawa/import')) { ?>
											<a class="layui-btn layui-btn-small" id="uploadcsv">
												<i class="fa fa-search"></i>导入
											</a>
										<?php } ?>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/zdrawa/importui.html">

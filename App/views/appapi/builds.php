...
<html>
	<head>
    	...
    	<link href="/css/iconfont.css?rel=1" rel="stylesheet"/>
	</head>
	<body>
	...
	<script type="text/javascript">
		...
		mui.plusReady(function() {
			if(plus.device.model === 'iPhone11,8'||plus.device.model === 'iPhone10,3'||plus.device.model === 'iPhone10,6'||plus.device.model === 'iPhone11,2'||plus.device.model === 'iPhone11,6'||plus.device.model === 'iPhoneX'){ 
				$("nav.mui-bar-tab").css('height', '60px');
				$("nav.mui-bar-tab").css('padding-bottom', '34px');
				$("div.xqtb").css('height', '60px');
				$("div.xqtb").css('padding-bottom', '34px');
			};
		});
		$('#oncode').on('tap', function(){
			...
			ajax('/api/send_code.html', data, success);
		});
		var InterValObj; 
		var count = 60; 
		var curCount;
		...
		$('#contract_submit').on('tap', function(){
			...
			ajax('/api/contract_submit.html', data, success);
		});
	</script>
</html>
...
<body>
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/banner/modify" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			<input type="hidden" name="id" value="<?php echo $banner['id']; ?>" />
			<input type="hidden" name="current_page" value="<?php echo $current_page; ?>" />
            <div class="layui-form-item">
                <label class="layui-form-label">名称</label>
				<div class="layui-input-inline">
					<input name='name' type="text" autocomplete="off" lay-verify="required" placeholder="必填,名称" class="layui-input"  maxlength="20" value="<?php echo $banner['name'] ?>" />
				</div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">描述</label>
				<div class="layui-input-inline">
					<input name='info' type="text" autocomplete="off" lay-verify="required" placeholder="必填,描述" class="layui-input"  maxlength="50" value="<?php echo $banner['info'] ?>"/>
				</div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name='sort' type="text" autocomplete="off" lay-verify="required|number" placeholder="必填,排序" class="layui-input"  maxlength="10" value="<?php echo $banner['info'] ?>"/>
				</div>
            </div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
                <div class="layui-input-inline">
					<img src='<?php echo $banner['img'] ?>' width='100' />
                ...
                <div class="btn-list">
                    <div class="btnlist">
						<?php if(is_rule('/banner/add')) { ?>
							<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="btnsubmit" data-url="/banner/modify"><i class="layui-icon">&#x1005;</i>提交</a>
						<?php  } ?>

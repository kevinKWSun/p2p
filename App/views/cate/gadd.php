...
<body>
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/cate/gadd" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="title" autocomplete="off" lay-verify="required" value="" placeholder="必填,商品名称" class="layui-input" type="text">
                </div>
            </div>
			<div class="layui-form-item">
                <label class="layui-form-label">所需积分</label>
                <div class="layui-input-block">
                    <input name="score" autocomplete="off" lay-verify="required" value="" placeholder="必填,所需积分" class="layui-input" type="text">
                </div>
            </div>
			<div class="layui-form-item">
				...
				<textarea class="layui-textarea" id="LAY_demo2" placeholder="必填,详情说明"></textarea>
            ...
            <div class="page-footer">
                <div class="btn-list">
                    <div class="btnlist">
                        <a class="layui-btn layui-btn-sm" lay-submit="" lay-filter="btnsubmit" data-url="/cate/gadd"><i class="layui-icon">&#x1005;</i>提交</a>

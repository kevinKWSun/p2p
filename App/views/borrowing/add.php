                ...
                <div class="btn-list">
                    <div class="btnlist">
						<?php if(is_rule('/borrowing/add')) { ?>
							<a class="layui-btn layui-btn-small" lay-submit="" lay-filter="btnsubmit" data-url="/borrowing/add"><i class="layui-icon">&#x1005;</i>提交</a>
						<?php  } ?>
				...
				,done: function(res){
					...
					$.each(res, function(key, val){
						if(res[key].code == 200){
							...
							var obj = "<div class='layui-inline'><img height='200' src='"+res[key].savepath+"' /></div>";
							$('.pic').before(obj);
							console.log(img);
						}
					});

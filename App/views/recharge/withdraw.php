                        ...
                        <div class="l-list clearfix">
                            <form id="tt" class="layui-form layui-form-pane">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <a class="layui-btn layui-btn-small" lay-submit="" lay-filter="search" data-url="/recharge/withdraw.html">
									...
									<div class="layui-inline">
										<a class="layui-btn layui-btn-small" lay-submit="" lay-filter='excel' data-url="/excel/withdraw.html">
                                            <i class="layui-icon"></i>导出
                                        </a>
                                        <a class="layui-btn layui-btn-small do-action" data-type="doRefresh" data-url="/recharge/withdraw.html">
                ...
                <form class="form-horizontal" id="formrec" method="post" role="form">
                    <table class="layui-table layui-tables" lay-skin="line">
                        ...
                        <tbody>
                            ...
                            <?php }else{foreach ($withdraw as $v): ?>
                            <tr>

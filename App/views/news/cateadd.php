...
<body>
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/news/cadd" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
            <div class="layui-form-item">
                <label class="layui-form-label">分类名称</label>
                <div class="layui-input-block">
                    <input name="lname" autocomplete="off" lay-verify="required" value="" placeholder="必填,分类名称" class="layui-input" type="text">
                </div>
            </div>
            <!--底部工具栏-->
                ...
                <div class="btn-list">
                    <div class="btnlist">
						<?php if(is_rule('/news/cadd')) { ?>
							<a class="layui-btn layui-btn-sm" lay-submit="" lay-filter="doPost" data-url="/news/cadd"><i class="layui-icon">&#x1005;</i>提交</a>
						<?php } ?>

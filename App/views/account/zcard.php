			...
			<div class="jyjl">
				<div class="jyjl">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<?php foreach ($zcard as $v): ?>
						<tr>
							<td><?php echo $product[$v['type']]; ?></td>
							<td><?php echo $v['status'] ? '已处理' : '待处理'; ?></td>
							<td><?php echo $v['nums']; ?></td>
							<td><?php if($v['puptime']){echo date('Y-m-d',$v['puptime']);}else{echo date('Y-m-d',$v['add_time']);} ?></td>

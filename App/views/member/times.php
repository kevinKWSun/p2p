...
<body>
    <div class="main-wrap" style='padding:10px;'>
        ...
        <form action="/member/times" class="layui-form layui-form-pane" id="formrec" method="post" role="form">
			...
			<div class="layui-form-item">
                <label class="layui-form-label">已有单倍抽奖次数</label>
				<div class="layui-input-inline">
                    <input value="<?php echo isset($zcash['total']) ? $zcash['total'] : 0;?>" class="layui-input layui-btn-disabled" type="text" disabled />
                </div>
            </div>
			<div class="layui-form-item">
                <label class="layui-form-label">已有双倍抽奖次数</label>
				<div class="layui-input-inline">
                    <input value="<?php echo isset($zcash['doub']) ? $zcash['doub'] : 0;?>" class="layui-input layui-btn-disabled" type="text" disabled />
                </div>
            </div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="doub" type="radio"  checked value="1"/>单倍 <input name="doub" type="radio" value="2"/>双倍
                </div>
            </div>
			<div class="layui-form-item">
